 ...
 * @author USER
 */
@WebServlet(name = "LoadNextQuestionServlet", urlPatterns = {"/LoadNextQuestionServlet"})
public class LoadNextQuestionServlet extends HttpServlet {

    private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(LoadNextQuestionServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Ans Ticked");
        System.out.println(tickedAns);
        if (tickedAns == null) {
            tickedAns = "";
        }
        ...
        try {
            ...
            QuestionCart cartBefore = cartList.get(currentNum - 1);
            cartBefore.setAnsTicked(tickedAns);
